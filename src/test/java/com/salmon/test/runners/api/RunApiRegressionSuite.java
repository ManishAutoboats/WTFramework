...
@CucumberOptions(features = "src/test/resources/features/api", tags = {"@MiddlewareToMagento"}, monochrome = true, plugin = {
...
public class RunApiRegressionSuite extends AbstractTestNGCucumberTests {
}
