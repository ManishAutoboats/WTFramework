...
@CucumberOptions(features = "src/test/resources/features/api", tags = {"@apiDe"}, monochrome = true, plugin = {
...
public class RunApiRegressionBEVeloSuite extends AbstractTestNGCucumberTests {
}
